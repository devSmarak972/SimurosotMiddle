...
void protobuf_AssignDesc_sslDebug_5fData_2eproto() {
  ...
  static const int sslDebug_Data_offsets_[4] = {
...
const sslDebug_Data& sslDebug_Data::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_sslDebug_5fData_2eproto();  return *default_instance_;
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(10)) goto parse_circle;
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_line;
        if (input->ExpectTag(26)) goto parse_botpos;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(26)) goto parse_botpos;
        if (input->ExpectTag(34)) goto parse_ballpos;
        break;
      }
...
void sslDebug_Data::SerializeWithCachedSizes(
  ...
  for (int i = 0; i < this->botpos_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->botpos(i), output);
  }
  
  // repeated .Debug_AdjustBall ballpos = 4;
  for (int i = 0; i < this->ballpos_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, this->ballpos(i), output);
  }
