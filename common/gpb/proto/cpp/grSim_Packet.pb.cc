...
void protobuf_AssignDesc_grSim_5fPacket_2eproto() {
  ...
  static const int grSim_Packet_offsets_[3] = {
...
void grSim_Packet::InitAsDefaultInstance() {
  ...
  debuginfo_ = const_cast< ::sslDebug_Data*>(&::sslDebug_Data::default_instance());
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_debuginfo;
        break;
      }
