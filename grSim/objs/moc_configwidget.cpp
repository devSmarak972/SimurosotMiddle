...
**
** Created: Mon Mar 25 04:50:06 2013
...
static const char qt_meta_stringdata_ConfigWidget[] = {
    "ConfigWidget\0\0loadRobotsSettings()\0"
};

const QMetaObject ConfigWidget::staticMetaObject = {
    { &VarTreeView::staticMetaObject, qt_meta_stringdata_ConfigWidget,
...
int ConfigWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: loadRobotsSettings(); break;
        default: ;
        }
        _id -= 1;
    }
...
static const char qt_meta_stringdata_ConfigDockWidget[] = {
    "ConfigDockWidget\0\0closeSignal(bool)\0"
};

const QMetaObject ConfigDockWidget::staticMetaObject = {
    { &QDockWidget::staticMetaObject, qt_meta_stringdata_ConfigDockWidget,
      qt_meta_data_ConfigDockWidget, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ConfigDockWidget::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ConfigDockWidget))
        return static_cast<void*>(const_cast< ConfigDockWidget*>(this));
...
int ConfigDockWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: closeSignal((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
