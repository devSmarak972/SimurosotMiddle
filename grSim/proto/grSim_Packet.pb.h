...
class grSim_Packet : public ::google::protobuf::Message {
 public:
  ...
  inline const ::sslDebug_Data& debuginfo() const;
  inline ::sslDebug_Data* mutable_debuginfo();
  inline ::sslDebug_Data* release_debuginfo();
...
inline ::sslDebug_Data* grSim_Packet::mutable_debuginfo() {
  set_has_debuginfo();
  if (debuginfo_ == NULL) debuginfo_ = new ::sslDebug_Data;
  return debuginfo_;
}
